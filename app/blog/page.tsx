...
export const metadata = {
  ...
  description: 'Deep dive technical resources covering bidirectional layout algorithms, font parsing performance, and internationalization SEO.',
};
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <header className="mb-12 border-b border-slate-200 pb-8">
          ...
          <p className="text-slate-500 mt-2 text-base sm:text-lg">
            Advanced optimization procedures for building responsive multilingual web platforms.
          </p>
        </header>
          ...
          {englishArticles.map((article) => (
            <article key={article.slug} className="bg-white p-6 sm:p-8 rounded-2xl border border-slate-200 shadow-2xs hover:shadow-xs transition-shadow">
              ...
              <div className="flex items-center justify-between mt-6 pt-4 border-t border-slate-100 text-xs text-slate-400 font-mono">
                <span>Published: {article.publishedAt} • {article.readTime}</span>
